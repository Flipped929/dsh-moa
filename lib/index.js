...
export const Config = z.object({
   ...
   *  架构 v3.2（2026-09-10 用户裁定——页面选的模型为主模型；子模型 GLM 双档；deepseek-flash 任异步内控与异构）：
   *  常规=GLM-5.3-flash（coding plan Pro）；高难度执行=GLM-5.3（roster）；
   *  异构 devil/视觉 + 异步内控 navigator=deepseek-flash（DeepSeek-V41-Flash 正式版，原生多模态，与 GLM/k3 主力异构）。 */
