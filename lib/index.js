...
export const Config = z.object({
   ...
   *  订阅优先（2026-09-02 用户裁定）：常规/深度用 GLM（coding plan Pro），
   *  视觉/devil 用 kimi-k3（Allegro 年会员）；DeepSeek 仅补充。 */
  cheapModel: z.string().default('codex/glm-5.3-flash'),
  deepModel: z.string().default('codex/glm-5.3'),
