...
export const Config = z.object({
  ...
  /** 自动调度矩阵四槽位（provider/model）：常规/视觉/高 stakes/跨家族。 */
  cheapModel: z.string().default('deepseek-official/deepseek-v4-flash-vision-exp'),
  visionModel: z.string().default('deepseek-official/deepseek-v4-flash-vision-exp'),
