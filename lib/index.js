...
export const Config = z.object({
   ...
   *  常规=GLM-5.3-flash（coding plan Pro）；高难度执行=GLM-5.3（roster）；高 stakes critic/navigator=v4-pro（A/B 实证+第三家族）；
   *  异构 devil/视觉=v4.1-flash（DeepSeek 家族原生多模态；⚠️ 模型 2026-09-10 到期，到期后换回 vision-exp 或届时再裁定）。 */
  cheapModel: z.string().default('zai-coding-cn/glm-5.3-flash'),
  visionModel: z.string().default('deepseek-official/deepseek-v4.1-flash-expires-on-0910'),
  proModel: z.string().default('deepseek-official/deepseek-v4-pro'),
  devilModel: z.string().default('deepseek-official/deepseek-v4.1-flash-expires-on-0910'),
});
