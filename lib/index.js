...
export const Config = z.object({
   ...
   *  订阅优先（2026-09-02 用户裁定；v0.3.3 起 GLM 评审席改 DSH spawn 常驻——alpha.4 实证 zai-coding-cn 直连）：
   *  常规/深度用 GLM（coding plan Pro），视觉/devil 用 kimi-k3（Allegro 年会员）；DeepSeek 仅补充。 */
  cheapModel: z.string().default('zai-coding-cn/glm-5.3-flash'),
  deepModel: z.string().default('zai-coding-cn/glm-5.3'),
